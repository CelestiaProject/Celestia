...
`sudo apt-key add -echo "deb https://download.opensuse.org/repositories/home:/munix9:/unstable/Debian_10/ ./" `
  
`sudo tee /etc/apt/sources.list.d/celestia-obs.list`

  `sudo apt update && sudo apt install celestia`

### On Ubuntu 18.04 and derived systems:
  `curl https://download.opensuse.org/repositories/home:/munix9:/unstable/Ubuntu_18.04/Release.key`
  
`sudo apt-key add -echo "deb https://download.opensuse.org/repositories/home:/munix9:/unstable/Ubuntu_18.04/ ./"`
