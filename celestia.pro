TEMPLATE = app
TARGET = Celestia_QT$$QT_MAJOR_VERSION$$QT_MINOR_VERSION
VERSION = 1.7.0
DESTDIR = .
OBJECTS_DIR = obj
MOC_DIR = moc
...
# Also altered intl to libintl so VSS & QT will use different libs.
# Needed so VS versions are more portable.
