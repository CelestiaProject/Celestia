...
constexpr auto CLASSES_INVISIBLE_AS_POINT    = BodyClassification::Invisible      |
                 ...
                 BodyType bodyType)
{
    ...
    if (util::is_set(classification, CLASSES_INVISIBLE_AS_POINT))
        body->setVisibleAsPoint(false);
    if (!util::is_set(classification, CLASSES_SECONDARY_ILLUMINATOR))
