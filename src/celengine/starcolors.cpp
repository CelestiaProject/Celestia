...
constexpr std::array<Color, 401> StarColors_Blackbody_2deg_D65
{
...
GetStarColorTable(ColorTableType ct)
{
    ...
    case ColorTableType::Enhanced:
        static const ColorTemperatureTable* enhanced = std::make_unique<ColorTemperatureTable>(StarColors_Enhanced, 40000.0f).release();
        return enhanced;

    case ColorTableType::Blackbody_D65:
        static const ColorTemperatureTable* blackbodyD65 = std::make_unique<ColorTemperatureTable>(StarColors_Blackbody_2deg_D65, 40000.0f).release();
        return blackbodyD65;
