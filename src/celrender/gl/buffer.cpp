...
Buffer::Buffer(Buffer::TargetHint targetHint, util::array_view<std::byte> data, Buffer::BufferUsage usage) :
    Buffer(targetHint)
{
    bind();
    setData(data, usage);
...
Buffer&
Buffer::setData(util::array_view<std::byte> data, Buffer::BufferUsage usage)
{
