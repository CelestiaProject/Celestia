...
BookmarkManager::initializeBookmarks()
{
    ...
    menuBookmarks->setTitle("Bookmarks Menu");
    menuBookmarks->setDescription("Add bookmarks to this folder to see them in the bookmarks menu.");
    ...
    toolbarBookmarks->setTitle("Bookmarks Toolbar");
    toolbarBookmarks->setDescription("Add bookmarks to this folder to see them in the bookmarks toolbar.");
    menuBookmarks->setFolded(false);
...
BookmarkManager::loadBookmarks(QIODevice* device)
{
    ...
    m_root = reader.read();
    if (m_root == NULL)
        QMessageBox::warning(NULL, "Error reading bookmarks file", reader.errorString());
    ...
    m_iconImage(iconImage)
{
    ...
    timeSourceCombo->addItem("Current simulation time",       (int) Url::UseUrlTime);
    timeSourceCombo->addItem("Simulation time at activation", (int) Url::UseSimulationTime);
    timeSourceCombo->addItem("System time at activation",     (int) Url::UseSystemTime);
