    ...
    julianDateSpin(NULL)
{
    ...
    julianDateSpin->setToolTip("Set Julian Date");
    ...
    QPushButton* setTimeButton = new QPushButton("Set time", buttonBox);
