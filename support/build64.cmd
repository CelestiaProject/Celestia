...
cmake -DCMAKE_PREFIX_PATH=%Qt5_DIR% -DCMAKE_GENERATOR_PLATFORM=x64 -DCMAKE_TOOLCHAIN_FILE=c:/tools/vcpkg/scripts/buildsystems/vcpkg.cmake -DENABLE_SPICE=OFF -DENABLE_TTF=ON ..
